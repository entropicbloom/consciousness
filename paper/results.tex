...
\begin{table}[htbp]
    ...
    \begin{tabular}{lcc}
        ...
        \bottomrule
    \end{tabular}
    \caption{Geometric matching accuracies for decoding output neuron class identity across 10 validation networks. Standard deviations reflect variance across network instances. Decoding from dropout networks achieves perfect 100\% accuracy with zero variance, indicating completely unambiguous relational encoding of class identity.}
