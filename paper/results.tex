...
\begin{figure}[htbp]
    ...
    \end{subfigure}
    \caption{Frobenius distances between test and reference Gram matrices for all permutations of test network output neurons. Red dots indicate the true permutation. Dropout training creates a clear separation between correct and incorrect permutations.}
