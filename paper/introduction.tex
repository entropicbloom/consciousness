...
Representations form a spectrum: bit strings are maximally ambiguous, while conscious brain states must be unambiguous (or at least significantly more so). Relational structure may be key to reducing ambiguity, as systems acquire partial meaning from their position within a network of relations \citep{lyre2022neurophenomenal}.
