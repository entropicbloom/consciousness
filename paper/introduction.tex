...
Representations form a spectrum: bit strings are maximally ambiguous, while conscious brain states must be unambiguous (or at least significantly more so). Intermediate cases exist---for instance, a dictionary's words acquire partial meaning through relational structure even without prior language knowledge \citep{lyre2022neurophenomenal}. This suggests relational structure reduces ambiguity.
