Conventional representations (letters, words, bit strings) are ambiguous: a bit string can be decoded as a JPEG image or an MP3 audio file depending on the decoding scheme applied \citep{searle1980minds}. Nothing inherent in the representation determines its content; meaning depends entirely on an external decoder.
